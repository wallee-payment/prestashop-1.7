...
<div id="wallee_notifications" style="display:none;">
	<li id="wallee_manual_notif"class="dropdown">	
		<a href="javascript:void(0);" class="dropdown-toggle wallee_manual_notif notifs" data-toggle="dropdown">
			<i class="icon-bullhorn"></i>
				<svg class="wallee-icon-bullhorn-svg" viewBox="24 16 64 64">
				...
				{if $manualTotal > 0}					
					<span id="wallee_manual_notif_number_wrapper" class="notifs_badge">
						<span id="wallee_manual_notif_value">{$manualTotal|escape:'html':'UTF-8'}</span>
					</span>
				{/if}
		</a>
		<div class="dropdown-menu notifs_dropdown" id="dropdown_wallee_manual">
			<section id="wallee_manual_notif_wrapper" class="notifs_panel" style="width:250px">
				<div class="notifs_panel_header">
					<h3>Manual Tasks</h3>
				</div>
				<div id="list_wallee_manual_notif" class="list_notif">
					{if $manualTotal > 0}
