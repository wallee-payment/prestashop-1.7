...
## To install module manually by dragging up zip file, please download [.zip archive](https://plugin-documentation.wallee.com/wallee-payment/prestashop-1.7/1.2.50/wallee.zip) of module with correct structure required by Prestashop installation.
...
* [English](https://plugin-documentation.wallee.com/wallee-payment/prestashop-1.7/1.2.50/docs/en/documentation.html)
...
Please see the [license file](https://github.com/wallee-payment/prestashop-1.7/blob/1.2.50/LICENSE) for more information.
